          ...
          <div className="text-center">
            ...
            >
              <div className="relative inline-block">
                <motion.div 
                  className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-primary shadow-2xl shadow-primary/25 mx-auto"
                ...
                <motion.div 
                  className="absolute -inset-1 rounded-full bg-gradient-to-r from-primary to-secondary opacity-75 blur-sm -z-10"
                  animate={{ rotate: 360 }}
            ...
            >
              ...
              >
                <Button
                  asChild
                  variant="outline"
                  className="border-2 border-primary text-primary hover:bg-primary hover:text-white px-8 py-3 rounded-full font-medium transition-all duration-300"
                >
                  <a href="/projects">
            ...
            >
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-2xl text-gray-400 hover:text-accent transition-colors duration-200"
